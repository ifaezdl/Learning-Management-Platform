...
const PracticeExams = () => {
  ...
  const [selectedResult, setSelectedResult] =
    useState<PracticeExamResultItem | null>(null);
  ...
  const handleGenerateExam = async (courseId: number, skillTag: string) => {
    try {
      ...
      localStorage.setItem(
        "practiceExamData",
        JSON.stringify({ questions: response, courseId, skillTag }),
      );
            ...
            <div className="p-4">
              ...
              >
                <div className="d-flex align-items-center mb-3">
                  ...
                  >
                    <i
                      className="isax isax-book-square"
                ...
                <div className="row mt-4 g-3">
                  ...
                  <div className="col-md-3">
                    ...
                    >
                      ...
                      >
                        {weakSkillsData.reduce(
                          (acc, c) => acc + c.weakSkills.length,
                          0,
                        )}
                      </h4>
                    </div>
                  ...
                  <div className="col-md-3">
                    ...
                    >
                      ...
                      >
                        {practiceResults.length > 0
                          ? (
                              (practiceResults.filter((r) => r.isPassed)
                                .length /
                                practiceResults.length) *
                              100
                            ).toFixed(0)
              ...
              >
                <button
                  ...
                  style={{
                    padding: "1rem 1.5rem",
                    background:
                      activeTab === "weak-skills" ? "#667eea" : "transparent",
                ...
                <button
                  ...
                  style={{
                    padding: "1rem 1.5rem",
                    background:
                      activeTab === "results" ? "#667eea" : "transparent",
              ...
              {activeTab === "weak-skills" && (
                <div className="row">
                      ...
                      <div className="card-body">
                        ...
                        {totalPages > 1 && (
                          ...
                          >
                            ...
                            >
                              <li
                                className={`page-item ${coursesPage === 1 ? "disabled" : ""}`}
                              >
                                <button
                                  className="page-link"
                                  onClick={() =>
                              ...
                              {Array.from({ length: totalPages }, (_, i) => (
                                <li
                                  key={i + 1}
                                  className={`page-item ${coursesPage === i + 1 ? "active" : ""}`}
                                >
                                  <button
                                    className="page-link"
                              ...
                              <li
                                className={`page-item ${coursesPage === totalPages ? "disabled" : ""}`}
                              >
                                <button
                                  className="page-link"
                                  onClick={() =>
                  ...
                  <div className="col-md-8">
                    {selectedCourseData &&
                    selectedCourseData.weakSkills.length > 0 ? (
                      <div className="row">
                          ...
                          <div key={skill.tag} className="col-md-6 mb-4">
                            ...
                            >
                              <div className="card-body">
                                ...
                                >
                                  <i
                                    className="isax isax-target me-2"
                                    style={{ color: "#667eea" }}
                                  ></i>
                                  {skill.tag}
                                </h6>
                  ...
                  {practiceResults.length > 0 ? (
                    <div className="table-responsive">
                      ...
                      >
                        ...
                        >
                          <tr>
                            <th style={{ color: "#64748b", fontWeight: "600" }}>
                              دوره
                            </th>
                            <th style={{ color: "#64748b", fontWeight: "600" }}>
                              مهارت
                                ...
                                <button
                                  onClick={async () => {
                                    ...
                                    try {
                                      ...
                                      console.error(err);
                                      setError(
                                        "خطایی در دریافت پاسخنامه رخ داد",
                                      );
                                    } finally {
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ padding: "2rem", direction: "rtl" }}
            >
              {/* Header Info */}
              <div className="text-center mb-4">
                <h5 style={{ color: "#1565C0", marginBottom: "0.5rem" }}>
                  پاسخنامه آزمون
                </h5>
                <p
                  style={{
                ...
                >
                  دوره: <strong>{selectedResult.courseTitle}</strong> | مهارت:{" "}
                  <strong>{selectedResult.skillTag}</strong>
                </p>
                <p
                  style={{
                    fontSize: "0.95rem",
                ...
                >
                  نمره: <strong>{selectedResult.score.toFixed(1)}</strong> از{" "}
                  <strong>{selectedResult.maxScore}</strong>
                  {" | "}تعداد سوالات صحیح:{" "}
                  <strong>{selectedResult.correctCount}</strong> از{" "}
              ...
              {loadingAnswers ? (
                <div className="text-center py-5">
                  ...
                  <p style={{ color: "#666", marginTop: "1rem" }}>
                    درحال بارگذاری پاسخنامه...
                  </p>
                </div>
              ) : answerDetails?.questions &&
                answerDetails.questions.length > 0 ? (
                <div
                  style={{
                    display: "flex",
