export const all_routes = {
  ...
  instructorEnrolledCourse: "/instructor/instructor-enrolled-course",
  ...
  adminCourseManagement: "/admin/course-management",
  adminStudentPerformance: "/admin/student-performance",
